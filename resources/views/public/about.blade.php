    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('about') }}" class="text-primary-600 font-medium border-b-2 border-primary-600">About</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                ...
                <a href="{{ route('about') }}" class="block px-3 py-2 text-primary-600 font-medium border-l-4 border-primary-600">About</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                    <div>
                        <div class="text-4xl font-bold text-primary-600">{{ $departments }}</div>
                        <div class="mt-2 text-gray-600">Departments</div>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-primary-600">{{ $facultyCount }}</div>
                        <div class="mt-2 text-gray-600">Faculty Members</div>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-primary-600">{{ $coursesCount }}</div>
                        <div class="mt-2 text-gray-600">Programs</div>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-primary-600">45+</div>
                        <div class="mt-2 text-gray-600">Years of Excellence</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 class="text-base text-primary-600 font-semibold tracking-wide uppercase">Our Legacy</h2>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Our Founding Vision</h3>
    ...
    <div class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="mt-4 text-xl text-gray-600">The principles that guide our journey</p>
            </div>
