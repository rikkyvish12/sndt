                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $course->code) }}" required maxlength="20">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="course_type" name="course_type">
                                ...
                                <option value="undergraduate" {{ old('course_type', $course->course_type) == 'undergraduate' ? 'selected' : '' }}>Undergraduate</option>
                                <option value="postgraduate" {{ old('course_type', $course->course_type) == 'postgraduate' ? 'selected' : '' }}>Postgraduate</option>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="duration" name="duration" value="{{ old('duration', $course->duration) }}" min="1" max="10" required>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="fees" name="fees" value="{{ old('fees', $course->fees) }}" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="total_seats" class="form-label">Total Seats</label>
                            <input type="number" class="form-control" id="total_seats" name="total_seats" value="{{ old('total_seats', $course->total_seats) }}" min="0">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="available_seats" name="available_seats" value="{{ old('available_seats', $course->available_seats) }}" min="0">
